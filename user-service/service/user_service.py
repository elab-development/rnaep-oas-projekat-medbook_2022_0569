...
from repository.user_repository import get_doctors_by_specialization
from dto.register_requestDTO import DoctorResponseDTO
...
async def search_doctors(db: AsyncSession, specialization: str):
    ...
    for user, doctor in results:
        doctors.append(DoctorResponseDTO(
            name=user.name,
